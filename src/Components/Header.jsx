  ...
  return (
    <header className="bg-purple-header shadow-md text-white w-full p-2 text-2xl flex items-center z-40 h-altura_navbar_md font-manrope ">
      <div className="py-4 px-7 w-full h-full flex flex-col md:flex-row justify-between items-start md:items-center contenedor">
        ...
        <section
          className={` bg-purple-header md:bg-inherit flex flex-col md:flex-row items-center  justify-center gap-5  md:static absolute left-0 top-0  w-full h-full md:h-5 md:w-auto z-5 ease-in duration-800 transition-all md:translate-y-0  md:p-2 duration-300 ${
            isOpen
              ? "translate-y-0 "
