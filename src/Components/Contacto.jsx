...
const Contacto = () => {
  return (
    <div className="flex justify-center items-center md:h-altura_pagina_md max-h-full font-manrope">
    <div className="md:grid md:grid-cols-4 md:grid-rows-2 flex flex-col px-16 py-8">
      <div className="md:col-span-3">
        ...
        <ul className="text-gray-secondary_text text-md md:text-lg">
          <li className="flex gap-4 items-center mb-4">
            <FontAwesomeIcon icon={faLocationDot} className="text-xl text-purple-header" />
            <span className="text-lg">Guiñazu s/n, Barrio San Cayeta, Santa Rosa, Mendoza</span>
          </li>
          <li className="flex gap-4 items-center mb-4">
            <FontAwesomeIcon icon={faWhatsapp} className="text-xl text-purple-header" />
          ...
          <li className="flex gap-4 items-center mb-4">
            <FontAwesomeIcon icon={faEnvelope} className="text-xl text-purple-header" />
            <span>sangabriel_contacto@yahoo.com.ar</span>
          </li>
          <li className="flex gap-4 items-center mb-4">
            <FontAwesomeIcon icon={faFacebook} className="text-xl text-purple-header" />
      ...
      <picture className="flex justify-end items-end">
        <img src={mapa} alt="" className="lg:w-[250px] lg:h-[250px] rounded-3xl w-full" />
      </picture>
